...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> JAPAN_MOD_TAB = CREATIVE_TAB.register("japan_mod_tab", 
        () -> CreativeModeTab.builder().icon(
        () -> new ItemStack(ModItems.RICE_BOWL.get()))
        .title(Component.translatable("creative_tab_japan_mod"))
