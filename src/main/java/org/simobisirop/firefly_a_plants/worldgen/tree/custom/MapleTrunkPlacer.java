...
import org.simobisirop.firefly_a_plants.worldgen.tree.ModTrunkPlacerTypes;
...
public class MapleTrunkPlacer extends TrunkPlacer {
    public static final Codec<MapleTrunkPlacer> CODEC = RecordCodecBuilder.create(pineTrunkPlacerInstance ->
            trunkPlacerParts(pineTrunkPlacerInstance).apply(pineTrunkPlacerInstance, MapleTrunkPlacer::new));
